...
Despite impressive success rates, Wan et al. identified a critical limitation: "Retrieval-Augmented Generation often produced mismatches in module selection (e.g., And retrieved as Or), while deterministic hard rule search strategy avoided these errors" [102]. This reveals a fundamental challenge: semantic similarity in embedding space does not guarantee functional equivalence in code. An "And" gate and an "Or" gate may have similar textual descriptions in documentation, leading RAG to retrieve the wrong module, but their functional behavior is completely different [103].
...
**Zhang et al. (2025): 4-Agent IDF Generation with 923 Sub-Agents**

Zhang et al.'s agentic workflow for automatic EnergyPlus IDF generation exemplifies the G-O-V architecture with unprecedented scale and specialization [126]. The system uses four core agents:
...
Lu et al.'s Data2BEM framework demonstrates a complementary G-O-V architecture focused on calibration and retrofit analysis [133]. The system uses four specialized agents:
...
**PhysicsGAN (Sisk et al. 2025)**: Enforces physical constraints by penalizing generated data that violates surrogate-predicted constraints during training [196]. For eVTOL takeoff trajectory design, the framework achieved:
...
**Gadde et al. (2025): Agentic AI Hardware Design**: Addresses LLM limitations (attention deficits, hallucinations, iterative loops) by decomposing tasks among multiple agents with critic agents evaluating generated properties [201]. Performance metrics include:
...
Cohn et al. demonstrated that human-in-the-loop prompt engineering for formative assessment scoring improved GPT-4's performance by up to 38.9% over a non-prompt-engineered baseline [254]. While this study focused on assessment rather than building simulation, it provides empirical evidence that structured scaffolding and iterative refinement (core principles of the training-first model) significantly improve learning outcomes compared to unstructured approaches [255].
...
Fernandes et al.'s BIM-GPT assistant achieved 94% success rate for single-function queries by integrating RAG with IFC parameter databases [288]. The system retrieves relevant IFC entities and properties before generating responses, ensuring accuracy and reducing hallucinations [289]. However, accuracy dropped to 49.5% for complex queries requiring multi-step reasoning, highlighting that RAG alone is insufficient for complex tasks [290].
...
[1] Hong, T., & Zhang, J. (2025). AI for building energy modeling: A transformation. [PDF document]

[2] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[3] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[4] Subin, P., et al. (2025). Physics-informed large language models for HVAC anomaly detection with autonomous rule generation. arXiv preprint. https://doi.org/10.48550/arxiv.2510.17146

[5] Schindler, F., et al. (2025). Bridging physical constraints and deep generative models via physics-aware normalizing flows. *Neurocomputing*, 131880. https://doi.org/10.1016/j.neucom.2025.131880

[6] Kim, J., et al. (2025). Language Models as BIM Interpreters: Unlocking IFC Data for Automation in Construction Informatics. *Social Science Research Network*. https://doi.org/10.2139/ssrn.5563440

[7] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[8] Xia, Y., et al. (2025). Federated Accelerated Deep Reinforcement Learning for Multi-Zone HVAC Control in Commercial Buildings. *IEEE Transactions on Smart Grid*. https://doi.org/10.1109/tsg.2024.3524756

[9] Cao, L. Instructional Alignment of Large Language Models: A Framework for Creating Personalized AI Teaching Assistants in Engineering Education. [Document]

[10] Curriculum Analysis Answer. (2025). [Internal document]

[11] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[12] Iranmanesh, A., et al. (2025). LLM-assisted Graph-RAG Information Extraction from IFC Data. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.16813

[13] Yang, X., et al. (2024). Physics-constrained graph modeling for building thermal dynamics. *Energy and AI*. https://doi.org/10.1016/j.egyai.2024.100346

[14] Nagarathinam, S., et al. (2024). PhyGICS – A Physics-informed Graph Neural Network-based Intelligent HVAC Controller for Open-plan Spaces. https://doi.org/10.1145/3632775.3661957

[15] Jiang, Y., & Dong, B. (2024). Modularized neural network incorporating physical priors for future building energy modeling. [PDF document]

[16] Yang, X., et al. (2024). Physics-constrained graph modeling for building thermal dynamics. *Energy and AI*. https://doi.org/10.1016/j.egyai.2024.100346

[17] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling fluid flow and heat convection. *The Physics of fluids*. https://doi.org/10.1063/5.0161114

[18] Jiang, Y., & Dong, B. (2024). Modularized neural network incorporating physical priors for future building energy modeling. [PDF document]

[19] Jiang, Y., & Dong, B. (2024). Modularized neural network incorporating physical priors for future building energy modeling. [PDF document]

[20] Jiang, Y., & Dong, B. (2024). Modularized neural network incorporating physical priors for future building energy modeling. [PDF document]

[21] Yang, X., et al. (2024). Physics-constrained graph modeling for building thermal dynamics. *Energy and AI*. https://doi.org/10.1016/j.egyai.2024.100346

[22] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling fluid flow and heat convection. *The Physics of fluids*. https://doi.org/10.1063/5.0161114

[23] Goldfeder, S., et al. (2024). Real-World Data and Calibrated Simulation Suite for Offline Training of Reinforcement Learning Agents to Optimize Energy and Emission in Buildings for Environmental Sustainability. https://doi.org/10.48550/arxiv.2410.03756

[24] Goldfeder, S., et al. (2024). Real-World Data and Calibrated Simulation Suite for Offline Training of Reinforcement Learning Agents to Optimize Energy and Emission in Buildings for Environmental Sustainability. https://doi.org/10.48550/arxiv.2410.03756

[25] Towards Scalable Physically Consistent Neural Networks: an Application to Data-driven Multi-zone Thermal Building Models. (2022). https://doi.org/10.48550/arxiv.2212.12380

[26] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling geometry-adaptive steady-state natural convection. *International Journal of Heat and Mass Transfer*. https://doi.org/10.1016/j.ijheatmasstransfer.2023.124593

[27] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling geometry-adaptive steady-state natural convection. *International Journal of Heat and Mass Transfer*. https://doi.org/10.1016/j.ijheatmasstransfer.2023.124593

[28] Di Natale, L., et al. (2022). Physically Consistent Neural Networks for building thermal modeling: Theory and analysis. *Applied Energy*. https://doi.org/10.1016/j.apenergy.2022.119806

[29] Stephanie, L. (2025). Indoor Temperature Prediction for Residential Heat Pumps: A Physics-Informed Machine Learning Approach. https://doi.org/10.5258/soton/p1254

[30] Shan, X., et al. (2025). Physics-Informed and Explainable Graph Neural Networks for Generalizable Urban Building Energy Modeling. *Applied Sciences*. https://doi.org/10.3390/app15168854

[31] Shan, X., et al. (2025). Physics-Informed and Explainable Graph Neural Networks for Generalizable Urban Building Energy Modeling. *Applied Sciences*. https://doi.org/10.3390/app15168854

[32] Li, Z., et al. (2024). Design information-assisted graph neural network for modeling central air conditioning systems. *Advanced Engineering Informatics*. https://doi.org/10.1016/j.aei.2024.102379

[33] Li, Z., et al. (2024). Design information-assisted graph neural network for modeling central air conditioning systems. *Advanced Engineering Informatics*. https://doi.org/10.1016/j.aei.2024.102379

[34] Zhu, X., et al. (2024). Chiller System Power Prediction by Physical-Informed Neural Network. [Document]

[35] Comprehensive Technical Analysis. (2025). [Internal document]

[36] Comprehensive Technical Analysis. (2025). [Internal document]

[37] Comprehensive Technical Analysis. (2025). [Internal document]

[38] Comprehensive Technical Analysis. (2025). [Internal document]

[39] Koenig, J., et al. (2024). KAN-ODEs: Kolmogorov-Arnold Network Ordinary Differential Equations for Learning Dynamical Systems and Hidden Physics. https://doi.org/10.48550/arxiv.2407.04192

[40] Koenig, J., et al. (2024). KAN-ODEs: Kolmogorov-Arnold Network Ordinary Differential Equations for Learning Dynamical Systems and Hidden Physics. https://doi.org/10.48550/arxiv.2407.04192

[41] Rigas, G., et al. (2024). Adaptive Training of Grid-Dependent Physics-Informed Kolmogorov-Arnold Networks. *arXiv.org*. https://doi.org/10.48550/arxiv.2407.17611

[42] Tian, W. (2024). Towards advanced uncertainty and sensitivity analysis of building energy performance using machine learning techniques. *Journal of Building Performance Simulation*. https://doi.org/10.1080/19401493.2024.2387071

[43] Koenig, J., et al. (2024). KAN-ODEs: Kolmogorov-Arnold Network Ordinary Differential Equations for Learning Dynamical Systems and Hidden Physics. https://doi.org/10.48550/arxiv.2407.04192

[44] Hou, Y., et al. (2025). Kolmogorov-Arnold Networks: A Critical Assessment of Claims, Performance, and Practical Viability. https://doi.org/10.21203/rs.3.rs-7063327/v1

[45] Kim, J., et al. (2025). Language Models as BIM Interpreters: Unlocking IFC Data for Automation in Construction Informatics. *Social Science Research Network*. https://doi.org/10.2139/ssrn.5563440

[46] Płoszaj-Mazurek, M., et al. (2024). Artificial intelligence and digital tools for assisting low-carbon architectural design: merging the use of machine learning, large language models, and building information modeling. [Document]

[47] Ibba, M., et al. (2024). ASK-BIM: A knowledge graph-powered AI system for natural language querying of BIM models. [Document]

[48] Kim, J., et al. (2025). Language Models as BIM Interpreters: Unlocking IFC Data for Automation in Construction Informatics. *Social Science Research Network*. https://doi.org/10.2139/ssrn.5563440

[49] Gao, X., et al. (2024). Multi-agent framework for schema-guided reasoning and tool-augmented interaction with IFC models. [Document]

[50] Płoszaj-Mazurek, M., et al. (2024). Artificial intelligence and digital tools for assisting low-carbon architectural design: merging the use of machine learning, large language models, and building information modeling. [Document]

[51] Comprehensive Technical Analysis. (2025). [Internal document]

[52] Comprehensive Technical Analysis. (2025). [Internal document]

[53] Fernandes, J., et al. (2024). A GPT-Powered Assistant for Real-Time Interaction with Building Information Models. *Buildings*, 14(8), 2499. https://doi.org/10.3390/buildings14082499

[54] Focused Literature Review. (2025). [Internal document]

[55] Iranmanesh, A., et al. (2025). LLM-assisted Graph-RAG Information Extraction from IFC Data. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.16813

[56] Iranmanesh, A., et al. (2025). LLM-assisted Graph-RAG Information Extraction from IFC Data. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.16813

[57] Comprehensive Technical Analysis. (2025). [Internal document]

[58] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[59] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[60] Comprehensive Technical Analysis. (2025). [Internal document]

[61] Comprehensive Technical Analysis. (2025). [Internal document]

[62] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[63] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[64] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[65] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[66] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[67] Comprehensive Technical Analysis. (2025). [Internal document]

[68] Comprehensive Technical Analysis. (2025). [Internal document]

[69] Comprehensive Technical Analysis. (2025). [Internal document]

[70] Comprehensive Technical Analysis. (2025). [Internal document]

[71] Comprehensive Technical Analysis. (2025). [Internal document]

[72] Comprehensive Technical Analysis. (2025). [Internal document]

[73] Zhang, J., et al. (2024). Advancing Building Energy Modeling with Large Language Models: Exploration and Case Studies. *Energy and Buildings*. https://doi.org/10.1016/j.enbuild.2024.114788

[74] Comprehensive Technical Analysis. (2025). [Internal document]

[75] Comprehensive Technical Analysis. (2025). [Internal document]

[76] Comprehensive Technical Analysis. (2025). [Internal document]

[77] Comprehensive Technical Analysis. (2025). [Internal document]

[78] Comprehensive Technical Analysis. (2025). [Internal document]

[79] Comprehensive Technical Analysis. (2025). [Internal document]

[80] Comprehensive Technical Analysis. (2025). [Internal document]

[81] Comprehensive Technical Analysis. (2025). [Internal document]

[82] Comprehensive Technical Analysis. (2025). [Internal document]

[83] Comprehensive Technical Analysis. (2025). [Internal document]

[84] Comprehensive Technical Analysis. (2025). [Internal document]

[85] Zhang, J., et al. (2024). Advancing Building Energy Modeling with Large Language Models: Exploration and Case Studies. *Energy and Buildings*. https://doi.org/10.1016/j.enbuild.2024.114788

[86] Comprehensive Technical Analysis. (2025). [Internal document]

[87] Comprehensive Technical Analysis. (2025). [Internal document]

[88] Comprehensive Technical Analysis. (2025). [Internal document]

[89] Comprehensive Technical Analysis. (2025). [Internal document]

[90] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[91] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[92] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[93] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[94] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[95] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[96] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[97] Hong, T., & Zhang, J. (2025). AI for building energy modeling: A transformation. [PDF document]

[98] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[99] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[100] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[101] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[102] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[103] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[104] Curriculum Analysis Answer. (2025). [Internal document]

[105] Comprehensive Technical Analysis. (2025). [Internal document]

[106] Comprehensive Technical Analysis. (2025). [Internal document]

[107] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[108] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[109] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[110] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[111] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[112] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[113] Comprehensive Technical Analysis. (2025). [Internal document]

[114] Comprehensive Technical Analysis. (2025). [Internal document]

[115] Comprehensive Technical Analysis. (2025). [Internal document]

[116] Comprehensive Technical Analysis. (2025). [Internal document]

[117] Curriculum Analysis Answer. (2025). [Internal document]

[118] Curriculum Analysis Answer. (2025). [Internal document]

[119] Comprehensive Technical Analysis. (2025). [Internal document]

[120] Comprehensive Technical Analysis. (2025). [Internal document]

[121] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[122] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[123] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[124] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[125] Hua, W., et al. (2025). SOCIA-Nabla: Textual Gradient Meets Multi-Agent Orchestration for Automated Simulator Generation. https://doi.org/10.48550/arxiv.2510.18551

[126] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[127] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[128] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[129] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[130] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[131] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[132] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[133] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[134] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[135] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[136] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[137] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[138] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[139] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[140] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[141] Hua, W., et al. (2025). SOCIA-Nabla: Textual Gradient Meets Multi-Agent Orchestration for Automated Simulator Generation. https://doi.org/10.48550/arxiv.2510.18551

[142] Hua, W., et al. (2025). SOCIA-Nabla: Textual Gradient Meets Multi-Agent Orchestration for Automated Simulator Generation. https://doi.org/10.48550/arxiv.2510.18551

[143] Hua, W., et al. (2025). SOCIA-Nabla: Textual Gradient Meets Multi-Agent Orchestration for Automated Simulator Generation. https://doi.org/10.48550/arxiv.2510.18551

[144] Hua, W., et al. (2025). SOCIA-Nabla: Textual Gradient Meets Multi-Agent Orchestration for Automated Simulator Generation. https://doi.org/10.48550/arxiv.2510.18551

[145] Hua, W., et al. (2025). SOCIA-Nabla: Textual Gradient Meets Multi-Agent Orchestration for Automated Simulator Generation. https://doi.org/10.48550/arxiv.2510.18551

[146] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[147] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[148] Qiu, Y. (2025). Multi-Agent Reinforcement Learning for Coordinated Smart Grid and Building Energy Management Across Urban Communities. *Jisuanji shenghuojia*. https://doi.org/10.54097/3veq6255

[149] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[150] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[151] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[152] Curriculum Analysis Answer. (2025). [Internal document]

[153] Xia, Y., et al. (2025). Federated Accelerated Deep Reinforcement Learning for Multi-Zone HVAC Control in Commercial Buildings. *IEEE Transactions on Smart Grid*. https://doi.org/10.1109/tsg.2024.3524756

[154] Xia, Y., et al. (2025). Federated Accelerated Deep Reinforcement Learning for Multi-Zone HVAC Control in Commercial Buildings. *IEEE Transactions on Smart Grid*. https://doi.org/10.1109/tsg.2024.3524756

[155] Toderean, L., et al. (2025). Heuristic based federated learning with adaptive hyperparameter tuning for households energy prediction. *Dental science reports*. https://doi.org/10.1038/s41598-025-96443-3

[156] Xia, Y., et al. (2025). Federated Accelerated Deep Reinforcement Learning for Multi-Zone HVAC Control in Commercial Buildings. *IEEE Transactions on Smart Grid*. https://doi.org/10.1109/tsg.2024.3524756

[157] Xia, Y., et al. (2025). Federated Accelerated Deep Reinforcement Learning for Multi-Zone HVAC Control in Commercial Buildings. *IEEE Transactions on Smart Grid*. https://doi.org/10.1109/tsg.2024.3524756

[158] Xia, Y., et al. (2025). Federated Accelerated Deep Reinforcement Learning for Multi-Zone HVAC Control in Commercial Buildings. *IEEE Transactions on Smart Grid*. https://doi.org/10.1109/tsg.2024.3524756

[159] Toderean, L., et al. (2025). Heuristic based federated learning with adaptive hyperparameter tuning for households energy prediction. *Dental science reports*. https://doi.org/10.1038/s41598-025-96443-3

[160] Toderean, L., et al. (2025). Heuristic based federated learning with adaptive hyperparameter tuning for households energy prediction. *Dental science reports*. https://doi.org/10.1038/s41598-025-96443-3

[161] Curriculum Validation Literature Review. (2025). [Internal document]

[162] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling fluid flow and heat convection. *The Physics of fluids*. https://doi.org/10.1063/5.0161114

[163] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling fluid flow and heat convection. *The Physics of fluids*. https://doi.org/10.1063/5.0161114

[164] Qiu, Y. (2025). Multi-Agent Reinforcement Learning for Coordinated Smart Grid and Building Energy Management Across Urban Communities. *Jisuanji shenghuojia*. https://doi.org/10.54097/3veq6255

[165] Qiu, Y. (2025). Multi-Agent Reinforcement Learning for Coordinated Smart Grid and Building Energy Management Across Urban Communities. *Jisuanji shenghuojia*. https://doi.org/10.54097/3veq6255

[166] Curriculum Validation Literature Review. (2025). [Internal document]

[167] Toderean, L., et al. (2025). Heuristic based federated learning with adaptive hyperparameter tuning for households energy prediction. *Dental science reports*. https://doi.org/10.1038/s41598-025-96443-3

[168] Curriculum Analysis Answer. (2025). [Internal document]

[169] Curriculum Analysis Answer. (2025). [Internal document]

[170] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[171] Curriculum Analysis Answer. (2025). [Internal document]

[172] Curriculum Analysis Answer. (2025). [Internal document]

[173] Comprehensive Technical Analysis. (2025). [Internal document]

[174] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[175] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[176] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[177] Comprehensive Technical Analysis. (2025). [Internal document]

[178] Comprehensive Technical Analysis. (2025). [Internal document]

[179] Yang, X., et al. (2024). Physics-constrained graph modeling for building thermal dynamics. *Energy and AI*. https://doi.org/10.1016/j.egyai.2024.100346

[180] Curriculum Analysis Answer. (2025). [Internal document]

[181] Curriculum Analysis Answer. (2025). [Internal document]

[182] Curriculum Analysis Answer. (2025). [Internal document]

[183] Curriculum Analysis Answer. (2025). [Internal document]

[184] Curriculum Analysis Answer. (2025). [Internal document]

[185] Curriculum Analysis Answer. (2025). [Internal document]

[186] Curriculum Analysis Answer. (2025). [Internal document]

[187] Curriculum Analysis Answer. (2025). [Internal document]

[188] Curriculum Analysis Answer. (2025). [Internal document]

[189] Curriculum Analysis Answer. (2025). [Internal document]

[190] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[191] Curriculum Analysis Answer. (2025). [Internal document]

[192] Subin, P., et al. (2025). Physics-informed large language models for HVAC anomaly detection with autonomous rule generation. arXiv preprint. https://doi.org/10.48550/arxiv.2510.17146

[193] Iranmanesh, A., et al. (2025). LLM-assisted Graph-RAG Information Extraction from IFC Data. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.16813

[194] Subin, P., et al. (2025). Physics-informed large language models for HVAC anomaly detection with autonomous rule generation. arXiv preprint. https://doi.org/10.48550/arxiv.2510.17146

[195] Drgona, J., et al. (2025). Safe physics-informed machine learning for dynamics and control. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.12952

[196] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[197] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[198] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[199] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[200] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[201] Gadde, R., et al. (2025). Hey AI, generate me a hardware code! Agentic AI-based hardware design & verification. *arXiv.org*. https://doi.org/10.48550/arxiv.2507.02660

[202] Gadde, R., et al. (2025). Hey AI, generate me a hardware code! Agentic AI-based hardware design & verification. *arXiv.org*. https://doi.org/10.48550/arxiv.2507.02660

[203] Gadde, R., et al. (2025). Hey AI, generate me a hardware code! Agentic AI-based hardware design & verification. *arXiv.org*. https://doi.org/10.48550/arxiv.2507.02660

[204] Gadde, R., et al. (2025). Hey AI, generate me a hardware code! Agentic AI-based hardware design & verification. *arXiv.org*. https://doi.org/10.48550/arxiv.2507.02660

[205] Subin, P., et al. (2025). Physics-informed large language models for HVAC anomaly detection with autonomous rule generation. arXiv preprint. https://doi.org/10.48550/arxiv.2510.17146

[206] Subin, P., et al. (2025). Physics-informed large language models for HVAC anomaly detection with autonomous rule generation. arXiv preprint. https://doi.org/10.48550/arxiv.2510.17146

[207] Subin, P., et al. (2025). Physics-informed large language models for HVAC anomaly detection with autonomous rule generation. arXiv preprint. https://doi.org/10.48550/arxiv.2510.17146

[208] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[209] Curriculum Analysis Answer. (2025). [Internal document]

[210] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling geometry-adaptive steady-state natural convection. *International Journal of Heat and Mass Transfer*. https://doi.org/10.1016/j.ijheatmasstransfer.2023.124593

[211] Towards Scalable Physically Consistent Neural Networks: an Application to Data-driven Multi-zone Thermal Building Models. (2022). https://doi.org/10.48550/arxiv.2212.12380

[212] Curriculum Analysis Answer. (2025). [Internal document]

[213] Comprehensive Technical Analysis. (2025). [Internal document]

[214] Iranmanesh, A., et al. (2025). LLM-assisted Graph-RAG Information Extraction from IFC Data. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.16813

[215] Curriculum Analysis Answer. (2025). [Internal document]

[216] Curriculum Analysis Answer. (2025). [Internal document]

[217] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[218] Gadde, R., et al. (2025). Hey AI, generate me a hardware code! Agentic AI-based hardware design & verification. *arXiv.org*. https://doi.org/10.48550/arxiv.2507.02660

[219] Kulkarni, C., et al. (2025). PKG-DPO: Optimizing Domain-Specific AI systems with Physics Knowledge Graphs and Direct Preference Optimization. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.18391

[220] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[221] Petreche, J., et al. PROJETO DE PESQUISA: Integração de Machine Learning e Physics-Informed ML na Simulação de Desempenho de Edifícios: Superando Limitações de Escala e Incerteza em Climas Tropicais. *FAPESP-ML-Building-Simulation*

[222] Curriculum Analysis Answer. (2025). [Internal document]

[223] Curriculum Analysis Answer. (2025). [Internal document]

[224] Curriculum Validation Literature Review. (2025). [Internal document]

[225] Curriculum Analysis Answer. (2025). [Internal document]

[226] Curriculum Validation Literature Review. (2025). [Internal document]

[227] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[228] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[229] Curriculum Analysis Answer. (2025). [Internal document]

[230] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[231] Curriculum Analysis Answer. (2025). [Internal document]

[232] Curriculum Analysis Answer. (2025). [Internal document]

[233] Curriculum Analysis Answer. (2025). [Internal document]

[234] Curriculum Analysis Answer. (2025). [Internal document]

[235] Curriculum Analysis Answer. (2025). [Internal document]

[236] Curriculum Analysis Answer. (2025). [Internal document]

[237] Curriculum Analysis Answer. (2025). [Internal document]

[238] Curriculum Analysis Answer. (2025). [Internal document]

[239] Curriculum Analysis Answer. (2025). [Internal document]

[240] Curriculum Analysis Answer. (2025). [Internal document]

[241] Curriculum Analysis Answer. (2025). [Internal document]

[242] Curriculum Analysis Answer. (2025). [Internal document]

[243] Curriculum Analysis Answer. (2025). [Internal document]

[244] Curriculum Analysis Answer. (2025). [Internal document]

[245] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[246] Iranmanesh, A., et al. (2025). LLM-assisted Graph-RAG Information Extraction from IFC Data. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.16813

[247] Curriculum Analysis Answer. (2025). [Internal document]

[248] Curriculum Analysis Answer. (2025). [Internal document]

[249] Curriculum Analysis Answer. (2025). [Internal document]

[250] Curriculum Analysis Answer. (2025). [Internal document]

[251] Curriculum Analysis Answer. (2025). [Internal document]

[252] Curriculum Analysis Answer. (2025). [Internal document]

[253] Curriculum Analysis Answer. (2025). [Internal document]

[254] Cohn, C., et al. (2025). CoTAL: Human-in-the-Loop Prompt Engineering for Generalizable Formative Assessment Scoring. [Document]

[255] Cohn, C., et al. (2025). CoTAL: Human-in-the-Loop Prompt Engineering for Generalizable Formative Assessment Scoring. [Document]

[256] Curriculum Analysis Answer. (2025). [Internal document]

[257] Curriculum Analysis Answer. (2025). [Internal document]

[258] Curriculum Analysis Answer. (2025). [Internal document]

[259] Curriculum Analysis Answer. (2025). [Internal document]

[260] Curriculum Analysis Answer. (2025). [Internal document]

[261] Curriculum Analysis Answer. (2025). [Internal document]

[262] Curriculum Analysis Answer. (2025). [Internal document]

[263] Curriculum Analysis Answer. (2025). [Internal document]

[264] Curriculum Analysis Answer. (2025). [Internal document]

[265] Drgoňa, J., et al. (2021). Physics-constrained deep learning for high-dimensional surrogate modeling and uncertainty quantification without labeled data. *Journal of Computational Physics*. https://doi.org/10.1016/j.jcp.2019.05.024

[266] Curriculum Validation Literature Review. (2025). [Internal document]

[267] Drgoňa, J., et al. (2021). Physics-constrained deep learning for high-dimensional surrogate modeling and uncertainty quantification without labeled data. *Journal of Computational Physics*. https://doi.org/10.1016/j.jcp.2019.05.024

[268] Curriculum Analysis Answer. (2025). [Internal document]

[269] Curriculum Validation Literature Review. (2025). [Internal document]

[270] Curriculum Analysis Answer. (2025). [Internal document]

[271] Cao, L. Instructional Alignment of Large Language Models: A Framework for Creating Personalized AI Teaching Assistants in Engineering Education. [Document]

[272] Cohn, C., et al. (2025). A theory of adaptive scaffolding for LLM-based pedagogical agents. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.01503

[273] Curriculum Analysis Answer. (2025). [Internal document]

[274] Curriculum Analysis Answer. (2025). [Internal document]

[275] Curriculum Analysis Answer. (2025). [Internal document]

[276] Hong, T., & Zhang, J. (2025). AI for building energy modeling: A transformation. [PDF document]

[277] Curriculum Analysis Answer. (2025). [Internal document]

[278] Curriculum Analysis Answer. (2025). [Internal document]

[279] Curriculum Analysis Answer. (2025). [Internal document]

[280] Jiang, Y., & Chen, Y. (2025). Efficient fine-tuning of large language models for automated building energy modeling in complex cases. [PDF document]

[281] Jiang, Y., & Chen, Y. (2025). Efficient fine-tuning of large language models for automated building energy modeling in complex cases. [PDF document]

[282] Jiang, Y., & Chen, Y. (2025). Efficient fine-tuning of large language models for automated building energy modeling in complex cases. [PDF document]

[283] Jiang, Y., & Chen, Y. (2025). Efficient fine-tuning of large language models for automated building energy modeling in complex cases. [PDF document]

[284] Curriculum Analysis Answer. (2025). [Internal document]

[285] Curriculum Analysis Answer. (2025). [Internal document]

[286] Curriculum Analysis Answer. (2025). [Internal document]

[287] Curriculum Analysis Answer. (2025). [Internal document]

[288] Fernandes, J., et al. (2024). A GPT-Powered Assistant for Real-Time Interaction with Building Information Models. *Buildings*, 14(8), 2499. https://doi.org/10.3390/buildings14082499

[289] Fernandes, J., et al. (2024). A GPT-Powered Assistant for Real-Time Interaction with Building Information Models. *Buildings*, 14(8), 2499. https://doi.org/10.3390/buildings14082499

[290] Fernandes, J., et al. (2024). A GPT-Powered Assistant for Real-Time Interaction with Building Information Models. *Buildings*, 14(8), 2499. https://doi.org/10.3390/buildings14082499

[291] Curriculum Analysis Answer. (2025). [Internal document]

[292] Curriculum Analysis Answer. (2025). [Internal document]

[293] Cohn, C., et al. (2025). A theory of adaptive scaffolding for LLM-based pedagogical agents. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.01503

[294] Cohn, C., et al. (2025). A theory of adaptive scaffolding for LLM-based pedagogical agents. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.01503

[295] Cohn, C., et al. (2025). A theory of adaptive scaffolding for LLM-based pedagogical agents. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.01503

[296] Cohn, C., et al. (2025). A theory of adaptive scaffolding for LLM-based pedagogical agents. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.01503

[297] Curriculum Analysis Answer. (2025). [Internal document]

[298] Curriculum Analysis Answer. (2025). [Internal document]

[299] Fu, C., et al. (2025). DebugTA: An LLM-based agent for simplifying debugging and teaching in programming education. arXiv preprint. https://doi.org/10.48550/arxiv.2510.11076

[300] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[301] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[302] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[303] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[304] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[305] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[306] Fu, C., et al. (2025). DebugTA: An LLM-based agent for simplifying debugging and teaching in programming education. arXiv preprint. https://doi.org/10.48550/arxiv.2510.11076

[307] Fu, C., et al. (2025). DebugTA: An LLM-based agent for simplifying debugging and teaching in programming education. arXiv preprint. https://doi.org/10.48550/arxiv.2510.11076

[308] Fu, C., et al. (2025). DebugTA: An LLM-based agent for simplifying debugging and teaching in programming education. arXiv preprint. https://doi.org/10.48550/arxiv.2510.11076

[309] Curriculum Analysis Answer. (2025). [Internal document]

[310] Curriculum Analysis Answer. (2025). [Internal document]

[311] Curriculum Analysis Answer. (2025). [Internal document]

[312] Curriculum Analysis Answer. (2025). [Internal document]

[313] Curriculum Analysis Answer. (2025). [Internal document]

[314] Hybrid Instructor AI Assessment In Academic Projects: Efficiency, Equity, And Methodological Lessons. (2025). https://doi.org/10.48550/arxiv.2510.22286

[315] Hybrid Instructor AI Assessment In Academic Projects: Efficiency, Equity, And Methodological Lessons. (2025). https://doi.org/10.48550/arxiv.2510.22286

[316] Hybrid Instructor AI Assessment In Academic Projects: Efficiency, Equity, And Methodological Lessons. (2025). https://doi.org/10.48550/arxiv.2510.22286

[317] Curriculum Analysis Answer. (2025). [Internal document]

[318] Curriculum Analysis Answer. (2025). [Internal document]

[319] Curriculum Analysis Answer. (2025). [Internal document]

[320] Curriculum Validation Literature Review. (2025). [Internal document]

[321] Curriculum Analysis Answer. (2025). [Internal document]

[322] Curriculum Analysis Answer. (2025). [Internal document]

[323] Curriculum Analysis Answer. (2025). [Internal document]

[324] Curriculum Analysis Answer. (2025). [Internal document]

[325] Curriculum Analysis Answer. (2025). [Internal document]

[326] Curriculum Analysis Answer. (2025). [Internal document]

[327] Curriculum Analysis Answer. (2025). [Internal document]

[328] Curriculum Analysis Answer. (2025). [Internal document]

[329] Curriculum Analysis Answer. (2025). [Internal document]

[330] Curriculum Analysis Answer. (2025). [Internal document]

[331] Curriculum Analysis Answer. (2025). [Internal document]

[332] Curriculum Analysis Answer. (2025). [Internal document]

[333] Cohn, C., et al. (2025). CoTAL: Human-in-the-Loop Prompt Engineering for Generalizable Formative Assessment Scoring. [Document]

[334] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[335] Hybrid Instructor AI Assessment In Academic Projects: Efficiency, Equity, And Methodological Lessons. (2025). https://doi.org/10.48550/arxiv.2510.22286

[336] Drgoňa, J., et al. (2021). Physics-constrained deep learning for high-dimensional surrogate modeling and uncertainty quantification without labeled data. *Journal of Computational Physics*. https://doi.org/10.1016/j.jcp.2019.05.024

[337] Curriculum Analysis Answer. (2025). [Internal document]

[338] Curriculum Analysis Answer. (2025). [Internal document]

[339] Curriculum Analysis Answer. (2025). [Internal document]

[340] Cohn, C., et al. (2025). A theory of adaptive scaffolding for LLM-based pedagogical agents. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.01503

[341] Curriculum Analysis Answer. (2025). [Internal document]

[342] Cohn, C., et al. (2025). A theory of adaptive scaffolding for LLM-based pedagogical agents. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.01503

[343] Towards Scalable Physically Consistent Neural Networks: an Application to Data-driven Multi-zone Thermal Building Models. (2022). https://doi.org/10.48550/arxiv.2212.12380

[344] Jiang, Y., & Dong, B. (2024). Modularized neural network incorporating physical priors for future building energy modeling. [PDF document]

[345] Yang, X., et al. (2024). Physics-constrained graph modeling for building thermal dynamics. *Energy and AI*. https://doi.org/10.1016/j.egyai.2024.100346

[346] Goldfeder, S., et al. (2024). Real-World Data and Calibrated Simulation Suite for Offline Training of Reinforcement Learning Agents to Optimize Energy and Emission in Buildings for Environmental Sustainability. https://doi.org/10.48550/arxiv.2410.03756

[347] Peng, W., et al. (2023). Physics-informed graph convolutional neural network for modeling fluid flow and heat convection. *The Physics of fluids*. https://doi.org/10.1063/5.0161114

[348] Comprehensive Technical Analysis. (2025). [Internal document]

[349] Comprehensive Technical Analysis. (2025). [Internal document]

[350] Iranmanesh, A., et al. (2025). LLM-assisted Graph-RAG Information Extraction from IFC Data. *arXiv.org*. https://doi.org/10.48550/arxiv.2504.16813

[351] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[352] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[353] Comprehensive Technical Analysis. (2025). [Internal document]

[354] Curriculum Analysis Answer. (2025). [Internal document]

[355] Zhang, Y., et al. (2025). Automatic building energy model development and debugging using large language models agentic workflow. [PDF document]

[356] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[357] Toderean, L., et al. (2025). Heuristic based federated learning with adaptive hyperparameter tuning for households energy prediction. *Dental science reports*. https://doi.org/10.1038/s41598-025-96443-3

[358] Qiu, Y. (2025). Multi-Agent Reinforcement Learning for Coordinated Smart Grid and Building Energy Management Across Urban Communities. *Jisuanji shenghuojia*. https://doi.org/10.54097/3veq6255

[359] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

[360] Gadde, R., et al. (2025). Hey AI, generate me a hardware code! Agentic AI-based hardware design & verification. *arXiv.org*. https://doi.org/10.48550/arxiv.2507.02660

[361] Kulkarni, C., et al. (2025). PKG-DPO: Optimizing Domain-Specific AI systems with Physics Knowledge Graphs and Direct Preference Optimization. *arXiv.org*. https://doi.org/10.48550/arxiv.2508.18391

[362] Curriculum Analysis Answer. (2025). [Internal document]

[363] Cohn, C., et al. (2025). CoTAL: Human-in-the-Loop Prompt Engineering for Generalizable Formative Assessment Scoring. [Document]

[364] Wan, H., et al. (2025). Automating Modelica Module Generation Using Large Language Models: A Case Study on Building Control Description Language. https://doi.org/10.48550/arxiv.2509.14623

[365] Hybrid Instructor AI Assessment In Academic Projects: Efficiency, Equity, And Methodological Lessons. (2025). https://doi.org/10.48550/arxiv.2510.22286

[366] Drgoňa, J., et al. (2021). Physics-constrained deep learning for high-dimensional surrogate modeling and uncertainty quantification without labeled data. *Journal of Computational Physics*. https://doi.org/10.1016/j.jcp.2019.05.024

[367] Curriculum Analysis Answer. (2025). [Internal document]

[368] Curriculum Analysis Answer. (2025). [Internal document]

[369] Curriculum Analysis Answer. (2025). [Internal document]

[370] Jiang, Y., & Dong, B. (2024). Modularized neural network incorporating physical priors for future building energy modeling. [PDF document]

[371] Lu, Y., et al. (2025). Automated building energy modeling for energy retrofits using a large language model-based multi-agent framework. *iScience*. https://doi.org/10.1016/j.isci.2025.113867

[372] Sisk, C., et al. (2025). Physics-constrained generative artificial intelligence for rapid takeoff trajectory design. arXiv preprint. https://doi.org/10.48550/arxiv.2501.03445

---

**Note**: This comprehensive literature review synthesizes findings from 888 unique papers published between 2024–2026, applying the top-30 rule to six combined paper tables. All quantitative metrics, empirical findings, and architectural patterns are grounded in the reviewed literature. The curriculum enhancements proposed in Section 6 directly address identified gaps while maintaining the curriculum's core strengths: domain-first progression, physics-constrained safety frameworks, multi-agent orchestration, and human-in-the-loop workflows.
